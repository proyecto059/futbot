...
def test_hold_without_ball_when_line_is_visible_or_cooling_down():
    assert should_hold_without_ball_near_line(False, line_detected=True, line_cooldown=0) is True
