"""Fachada del pipeline2 (sin ultrasónico) — punto de entrada único.
...
Este pipeline es igual al pipeline original pero SIN sensor ultrasónico.
"""
...
from pipeline2.dto.pipeline_output_dto import PipelineOutputDto
from pipeline2.operators.chase_operator import ChaseOperator
from pipeline2.operators.search_operator import SearchOperator
from pipeline2.utils.pipeline_constants import (
    CHASE,
    CHASE_BLIND_MS,
