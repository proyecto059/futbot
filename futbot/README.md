...
- **[GUIDE_USERS.md](GUIDE_USERS.md)** — Guía práctica para operar el robot físicamente
- **[GUIDE_TECHNICAL.md](GUIDE_TECHNICAL.md)** — Documentación técnica para desarrolladores
